...
export class ReflectManager {
  ...
  public static getTypeInfo(target: object, key?: string | symbol | undefined) {
  ...
  public static isDataSource(target: object): boolean {
    return Reflect.getMetadata(INJECT_DATA_SOURCE_TOKEN, target) !== undefined;
  }
  ...
  public static isGuard(target: object, propertyKey?: string): boolean {
    ...
    if (propertyKey) {
      return (
        Reflect.getMetadata(USE_GUARD_OPTION_TOKEN, target, propertyKey) !==
        undefined
      );
    } else {
      // 컨트롤러(클래스)인가?
      return Reflect.getMetadata(USE_GUARD_OPTION_TOKEN, target) !== undefined;
    }
  }
  ...
  public static isBeforeTransactionMethod(target: object, key: string) {
    return (
      Reflect.getMetadata(BEFORE_TRANSACTION_TOKEN, target, key) !== undefined
    );
  }
  ...
  public static isAfterTransactionMethod(target: object, key: string) {
    return (
      Reflect.getMetadata(AFTER_TRANSACTION_TOKEN, target, key) !== undefined
    );
  }
  ...
  public static isCommitMethod(target: object, key: string) {
    return (
      Reflect.getMetadata(TRANSACTION_COMMIT_TOKEN, target, key) !== undefined
    );
  }
  ...
  public static isRollbackMethod(target: object, key: string) {
    return (
      Reflect.getMetadata(TRANSACTION_ROLLBACK_TOKEN, target, key) !== undefined
    );
  }
  ...
  public static isTransactionalZoneMethod(target: object, key: string) {
    return Reflect.getMetadata(TRANSACTIONAL_TOKEN, target, key) !== undefined;
  }
  ...
  public static isRepository(target: any): boolean {
    ...
    return (
      Reflect.getMetadata(REPOSITORY_ENTITY_METADATA, target) !== undefined
    );
  }
  ...
  public static getRepositoryEntity(
    ...
    const store = Reflect.getMetadata(REPOSITORY_ENTITY_METADATA, target) ?? [];
