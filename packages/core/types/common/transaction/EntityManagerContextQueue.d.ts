...
import { TransactionIsolationLevel, TransactionPropagation } from "../decorators";
 ...
 * Queue 구조이므로 선입선출입니다.
 */
export declare class EntityManagerContextQueue {
    #private;
    /**
     * 새로운 트랜잭션이 시작될 때 큐에 새로운 컨텍스트를 추가합니다.
     * @param data
     */
    enqueue(data: Partial<TxContext>): void;
    /**
     * 큐에 있는 컨텍스트를 하나 비웁니다.
     *
     * @returns
     */
    dequeue(): TxContext | undefined;
    /**
     * 컨텍스트가 있는지 확인합니다.
     *
     * @returns
    ...
    get depth(): number;
    clear(): Promise<void>;
    [Symbol.iterator](): IterableIterator<TxContext>;
}
