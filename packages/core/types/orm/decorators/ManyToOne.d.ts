...
export declare const MANY_TO_ONE_TOKEN: unique symbol;
export declare const JOIN_COLUMN_TOKEN: unique symbol;
export type EntityLike<T = any> = ClazzType<T>;
export type RetrieveEntity<T> = () => T;
export type SetRelatedEntity<T extends EntityLike> = (entity: InstanceType<T>) => void;
 ...
 * user: User;
 */
export declare function ManyToOne<T extends EntityLike>(getMappingEntity: RetrieveEntity<T>, getMappingProperty: SetRelatedEntity<EntityLike>, option?: ManyToOneOption): PropertyDecorator;
