export type ColumnType = "int" | "number" | "float" | "double"
/** Date */
 | "timestamp" | "date" | "datetime"
/** Buffer */
 | "blob"
/** String */
 | "text" | "varchar" | "char" | "boolean" | "enum" | "json" | "jsonb" | "array" | "bigint" | "longtext";
...
export declare const COLUMN_TOKEN: unique symbol;
/**
 ...
 * @returns
 */
export declare function Column(option?: ColumnOption): PropertyDecorator;
