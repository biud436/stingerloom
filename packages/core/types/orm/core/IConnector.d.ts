...
export declare abstract class IConnector {
    ...
    abstract setTransactionIsolationLevel(connection: Connection, level: TRANSACTION_ISOLATION_LEVEL): Promise<void>;
    abstract startTransaction(connection: Connection, level?: TRANSACTION_ISOLATION_LEVEL): Promise<void>;
